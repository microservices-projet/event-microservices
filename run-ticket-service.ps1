...
Ticket Service - Port 8083
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Manages ticket sales, bookings, and reservations

Usage: .\run-ticket-service.ps1 [OPTIONS]
...
$ServicePort = 8083
$LogFile = "$PSScriptRoot\logs\ticket-service.log"
...
Write-Host "🗄️  Database: MySQL (localhost:3306/ticketdb)" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    if ($Clean) {
        ...
        mvn clean -pl microservices/ticket-service -q
    ...
    # Run service
    mvn -DskipTests -pl microservices/ticket-service spring-boot:run 2>&1 | Tee-Object -FilePath $LogFile

...
/**
 * Keycloak JWT first, then local HS256 (same as user-service / gateway).
 * Keycloak decoder is lazy so the app can start before Keycloak is reachable.
 */
@Configuration
    ...
    private static final class LazyCompositeJwtDecoder implements JwtDecoder {
        ...
        public Jwt decode(String token) throws JwtException {
            ...
            try {
                ...
                // Issuer metadata not reachable yet
            }
            if (kc != null) {
                try {
